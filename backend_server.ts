// server.ts - Main Express server for EncoreTalks API
...
app.use('/api/mentorship', authenticateUser, mentorshipRoutes);
app.use('/api/organizations', authenticateUser, organizationRoutes);
app.use('/api/affiliates', authenticateUser, affiliateRoutes);
...
app.listen(PORT, () => {
  console.log(`🚀 EncoreTalks API server running on port ${PORT}`);
